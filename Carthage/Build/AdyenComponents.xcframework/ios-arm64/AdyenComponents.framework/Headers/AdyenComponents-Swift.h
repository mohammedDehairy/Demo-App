...
#ifndef ADYENCOMPONENTS_SWIFT_H
#define ADYENCOMPONENTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AdyenComponents",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15AdyenComponents17ApplePayComponent")
...
@interface ApplePayComponent (SWIFT_EXTENSION(AdyenComponents)) <PKPaymentAuthorizationViewControllerDelegate>
